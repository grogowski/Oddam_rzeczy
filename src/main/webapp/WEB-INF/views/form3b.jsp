...
<div id="section1" class="container ml-1 text-center">
    ...
    <div class="row justify-content-center">
        <p class="display-4">Wybierz jedną z poniższych organizacji</p>
    </div>
</div>
<div class="jumbotron bg-primary text-white py-3">
    <h5>Poniżej znajduje się lista organizacji, które najlepiej spełniają wybrane przez Ciebie kryteria wyszukiwania.</h5>
</div>
<div id="form-section" class="container">
    <form action="/user/form3b" method="post">
